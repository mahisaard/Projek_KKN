...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Agu 2023 pada 06.06
...
(205, 'All about company profile', 'Company Profile', '<p style=\"text-align: justify;\">We are innovators in providing natural hydration with a strong dedication to quality. Taking selected natural water sources, we undergo a sophisticated production process to present A.M\'s \'Healthy and Barokah\' Mineral Water. In every bottle, we combine the goodness of nature with the best standards in the industry, ensuring a fresh and meaningful experience every time you drink it. Support your healthy hydration journey by choosing A.M Mineral Water as your loyal partner, produced by CV. Al Mubarok, Kab. Probolinggo.</p>', 'sht_2.png', 'en');
